...
<body>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            $id = $_GET['catid'];
            $sql = "SELECT * FROM `milktea` WHERE milkteaCategorieId = $id";
            $result = mysqli_query($conn, $sql);
            $noResult = true;
            while($row = mysqli_fetch_assoc($result)){
                $noResult = false;
                ...
                echo '<div class="col-lg-3 col-md-4 mb-4">
                        <div class=" "">
                            ...
                            <div class="card-body d-flex justify-content-center">
                                <h5 class="card-title text-nowrap">' . substr($milkteaName, 0, 20). '</h5>
                                <h6 style="color: #ff0000; font-weight: bold">₱'.$milkteaPrice. '</h6>
