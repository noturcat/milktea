...
<body>
    ...
    <div class="contact2" style="background-image:url(img/map.jpg);height: 868px;" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                    ...
                    <div class="contact-box p-4">
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger mt-3 mb-3 border-0 py-2 px-3"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                              <button type="button" class="btn btn-danger mt-3 mb-3 border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span> HISTORY <i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                            <button type="submit" class="btn btn-danger mt-3 mb-3 border-0 py-2 px-3"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                              <small class="form-text text-muted">Login to Contct with Us.</small>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background: #502421">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://facebook.com/" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-facebook"></i></i></a>
