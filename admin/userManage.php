                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/peteat/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/peteat/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(254 249 194);">
        <h5 class="modal-title font-weight-bold" id="editUser<?php echo $Id; ?>">User Id: <b><?php echo $Id; ?></b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                ...
                <div class="form-group col-md-4">
                    <img src="/peteat/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/peteat/img/profilePic.jpg'">
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
